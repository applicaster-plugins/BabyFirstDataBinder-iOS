...
class ZPDataBinderBabyFirst: ZPGeneralBaseProvider, ZPGeneralPluginUIProtocol {
    ...
    func viewController(options: [AnyHashable: Any]?) -> UIViewController? {
        ...
        if let xibName = options?["xibKeyName"] as? String,
            let classType = NSClassFromString("BabyFirstDataBinder.ZPBabyFirstCellViewController") as? CACellViewController.Type {
